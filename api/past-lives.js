...
- past_trace: 반드시 "전생의 {직업명} 때문에 이번생엔..." 으로 시작
- historical_figure: 반드시 실존 한국 역사 인물 (현대인 및 외국인 제외)
- story: 150~250자로 작성. 태어난 배경·주요 사건·감정의 변화·전환점을 담은 입체적인 서사.
  ...
  "lives": [
    {
      ...
      "gender": "남 또는 여",
      "group": "<group 값>",
      "story": "150~250자의 입체적인 생애 서사. 태어난 배경·주요 사건·감정의 변화·전환점을 담아 작성.",
      "death": "최후를 한 문장으로",
      "karma": "현생 업보를 한 문장으로",
      "past_trace": "전생의 {직업명} 때문에 이번생엔... 형식으로 한 문장",
